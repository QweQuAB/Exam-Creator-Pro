...
export default function ExamDetail() {
  ...
  const mcqCount = exam.questions.filter((q: any) => !q.questionType || q.questionType === "mcq").length;
  const essayCount = exam.questions.filter((q: any) => q.questionType === "essay").length;
                  ...
                  <div className="flex gap-2">
                    {mcqCount > 0 && (
                      <Badge variant="secondary" className="gap-1">
                        <FileText className="w-3 h-3" /> {mcqCount} MCQ
                      </Badge>
                    )}
                    {essayCount > 0 && (
                      <Badge variant="secondary" className="gap-1 bg-accent/10 text-accent border-accent/20">
                        <PenLine className="w-3 h-3" /> {essayCount} Essay
                      </Badge>
                    )}
                  </div>
                </>
                          ...
                          <div className="flex-1">
                            <div className="flex gap-2 mb-2 flex-wrap">
                              ...
                              {q.questionType === "essay" ? (
                                <Badge
                                  variant="outline"
                                  className="gap-1 text-xs bg-accent/10 text-accent border-accent/20"
                                >
                                ...
                                <Badge
                                  variant="outline"
                                  className="gap-1 text-xs bg-secondary text-muted-foreground"
                                >
